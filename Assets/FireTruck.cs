...
public class FireTruck : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gameManager.SelectedFireTruck == gameObject && gameManager.SelectedTile != null && gameManager.DestSelectModeOn == true)
        {
        ...
        if (gameManager.SelectedFireTruck == gameObject && gameManager.SelectedTile != null && gameManager.TargetSelectModeOn == true)
        {
    ...
    public void Selected()
    {
        ...
        gameManager.SelectedFireTruck = gameObject;
